...
export const meta: ArticleMeta = {
  ...
  coverImage: "/covers/cessione-del-quinto-problemi.webp",
  keywords: [
    "cessione del quinto",
    "DPR 180/1950",
    "credito al consumo",
...
export const article: Article = {
  ...
  content: [
    {
      type: "h2",
      text: "Cos'è la cessione del quinto",
      id: "definizione",
    },
    {
      type: "p",
    ...
    {
      type: "h2",
      text: "Durata, importi e quota cedibile",
      id: "durata",
    },
    {
      type: "p",
    ...
    },
    {
      ...
      rows: [
        [
          ...
          "Pensionamento + finanziamento",
        ],
        [
          "Dipendente privato",
          "120 mesi",
          "Un quinto netto",
          "Polizza vita + polizza rischio impiego",
          "Pensionamento + finanziamento",
        ],
        [
          "Pensionato INPS",
          "120 mesi",
          "Un quinto netto (no sotto minimo INPS)",
          "Polizza vita",
          "85-90 anni a estinzione",
        ],
        [
          "Dipendente privato + delega",
          "120 mesi",
          "Fino a due quinti (cumulato)",
          "Polizza vita + polizza impiego",
          "Pensionamento + finanziamento",
        ],
        [
          "Dipendente pubblico + delega",
          "120 mesi",
          "Fino a due quinti (cumulato)",
          "Polizza vita",
          "Pensionamento + finanziamento",
    ...
    {
      type: "h2",
      text: "Le garanzie obbligatorie: TFR e polizze",
      id: "garanzie",
    },
    {
      type: "p",
    ...
    {
      type: "h3",
      text: "Costi rimborsabili in caso di estinzione anticipata",
    },
    {
      type: "ul",
      items: [
    ...
    {
      type: "p",
      text: "Lo strumento di tutela più rapido è il ricorso all'Arbitro Bancario Finanziario (ABF), organismo di risoluzione alternativa delle controversie istituito presso la Banca d'Italia. L'ABF decide su controversie tra clienti e banche/finanziarie fino a 200.000 euro di valore, con procedura scritta e tempi contenuti (in genere 6-9 mesi). Le decisioni dell'ABF non sono vincolanti per il cliente, che resta libero di ricorrere al giudice ordinario, ma sono di norma rispettate dagli intermediari, anche per ragioni reputazionali e di vigilanza.",
    },
    {
      type: "h2",
      text: "Procedura operativa per contestare il contratto",
      id: "procedura-contestazione",
    },
    {
      type: "p",
      text: "Per chi sospetta anomalie nel proprio contratto di cessione del quinto, esiste una sequenza operativa consolidata che consente di formalizzare la contestazione e attivare i rimedi disponibili.",
    },
    {
      type: "ol",
      items: [
    ...
    {
      type: "h2",
      text: "Cessione del quinto e segnalazioni in Centrale dei Rischi",
      id: "centrale-rischi",
    },
    {
      type: "p",
    ...
    },
    {
      ...
      items: [
        {
          q: "Posso fare la cessione del quinto se ho già altri prestiti in corso?",
          a: "Sì, è possibile cumulare una cessione del quinto con una delegazione di pagamento, arrivando fino al doppio quinto (40%) della retribuzione netta. È invece più difficile sottoscrivere una nuova cessione del quinto se ne è già attiva una: il finanziatore esige di estinguere quella precedente con la nuova erogazione (operazione di rinnovo). La valutazione del merito creditizio resta in capo all'intermediario, che può comunque rifiutare in presenza di segnalazioni negative o sproporzione tra debiti e reddito disponibile.",
        },
        {
          q: "Cosa succede al mio finanziamento se vengo licenziato?",
          a: "Alla cessazione del rapporto di lavoro, il datore versa al finanziatore l'intero TFR accantonato fino a copertura del debito residuo. Se il TFR non è sufficiente, interviene la polizza rischio impiego (per i dipendenti privati), che rimborsa la parte mancante secondo i termini contrattuali. Eventuali quote residue non coperte da TFR e polizza restano a carico del debitore. È importante verificare le cause di esclusione della polizza: dimissioni, licenziamento per giusta causa o motivo soggettivo possono non essere coperti.",
        },
        {
          q: "Ho estinto anticipatamente la cessione del quinto: ho diritto al rimborso?",
          a: "Sì. In base alla sentenza Lexitor (Corte di Giustizia UE, causa C-383/18) e alla giurisprudenza italiana consolidata (Cass. Sez. Un. n. 8806/2022), l'estinzione anticipata dà diritto al rimborso proporzionale di tutti i costi del credito, inclusi quelli up-front (commissioni di intermediazione, spese di istruttoria) e i premi assicurativi non maturati. La richiesta va presentata al finanziatore con reclamo formale; in caso di rifiuto o di rimborso insufficiente, è possibile rivolgersi all'Arbitro Bancario Finanziario (ABF) entro 12 mesi dal reclamo.",
        },
        {
          q: "La cessione del quinto è un'operazione usuraria?",
          a: "Non in sé. La cessione del quinto è un contratto legittimo, regolato da norme speciali. Tuttavia, il TAEG effettivo (somma di interessi, commissioni e premi assicurativi obbligatori) può, in alcuni casi, superare il tasso soglia trimestrale fissato dal MEF in base alla Legge 108/1996. In tal caso, ai sensi dell'art. 1815, comma 2, c.c., la clausola sugli interessi è nulla e gli interessi non sono dovuti. La verifica richiede una perizia econometrica sul contratto specifico, da affidare a un tecnico qualificato.",
        },
        {
          q: "Il datore di lavoro può rifiutare la cessione del quinto?",
          a: "Per i dipendenti pubblici, la cessione opera ex lege e l'amministrazione è obbligata ad accettarla, salvo verificare i limiti di legge. Per i dipendenti privati, il datore di lavoro può rifiutare l'accettazione opponendo gravi motivi (ad esempio, dipendente con contratto a tempo determinato in scadenza, situazione lavorativa instabile). Il rifiuto deve essere comunicato in forma scritta e motivata. Se ingiustificato, il finanziatore può attivare la procedura di esecuzione coattiva della cessione (art. 1264 c.c.) ma è raramente praticata.",
        },
        {
          q: "Posso fare la cessione del quinto sulla pensione di invalidità civile?",
          a: "La pensione sociale e gli assegni di invalidità civile costituiti dal solo trattamento minimo non sono cedibili, perché sono prestazioni assistenziali impignorabili. La pensione di invalidità ordinaria INPS, invece, è cedibile nei limiti del quinto e nel rispetto del minimo INPS residuo. La pensione di reversibilità è cedibile alle stesse condizioni della pensione di vecchiaia. È sempre opportuno verificare con l'INPS l'esatta natura del trattamento per evitare contestazioni successive.",
        },
        {
          q: "Cosa rischio se il datore di lavoro non versa le trattenute al finanziatore?",
          a: "La trattenuta del quinto sullo stipendio è obbligatoria per il datore di lavoro una volta ricevuta la notifica della cessione. Se il datore non versa le somme al finanziatore (per errore, omissione, contenzioso interno), il debitore rischia di essere segnalato in Centrale dei Rischi come 'in ritardo', anche senza propria colpa. È fondamentale monitorare gli estratti conto del finanziatore e, in caso di anomalie, sollecitare per iscritto il datore e contestualmente il finanziatore. La responsabilità della trattenuta resta del datore, che risponde solidalmente.",
        },
        {
          q: "Posso revocare la cessione del quinto dopo averla firmata?",
          a: "Il consumatore ha diritto di recedere dal contratto entro 14 giorni dalla conclusione, ai sensi dell'art. 125-ter T.U.B., senza dover indicare il motivo e senza penali. Il diritto di recesso si esercita con comunicazione scritta inviata al finanziatore (PEC o raccomandata). Decorso il termine, è possibile estinguere anticipatamente il finanziamento in qualsiasi momento, con diritto al rimborso proporzionale dei costi non maturati. Se il contratto non riporta correttamente il diritto di recesso, il termine è prolungato di ulteriori 60 giorni dalla scoperta del difetto.",
        },
        {
          q: "Quante volte posso rinnovare la cessione del quinto?",
          a: "Il D.P.R. 180/1950 non pone un limite assoluto al numero di rinnovi, ma stabilisce che, in caso di rinnovo, deve essere trascorso almeno il 40% della durata del contratto precedente (per cessioni di durata inferiore a 5 anni il 40% della durata, per cessioni superiori a 5 anni almeno il 20%). Ogni rinnovo è un'operazione di estinzione anticipata e nuova erogazione, con diritto al rimborso proporzionale dei costi non maturati del precedente finanziamento (post-Lexitor). La pratica delle 'estinzioni continue' va monitorata: ogni operazione comporta costi e può non essere conveniente.",
        },
        {
          q: "Cosa posso fare se la cessione del quinto mi rende impossibile vivere?",
          a: "Se la rata di cessione (cumulata o meno con delegazione, prestiti, debiti per utenze) rende insostenibile la gestione familiare, è opportuno valutare l'accesso alle procedure di composizione delle crisi da sovraindebitamento previste dal Codice della Crisi (D.lgs. 14/2019). Il piano del consumatore (art. 67 CCII) consente di ristrutturare l'intera esposizione debitoria sulla base della capacità reddituale effettiva. La procedura passa tramite un Organismo di Composizione della Crisi (OCC) e richiede l'assistenza di un professionista qualificato (avvocato o commercialista).",
        },
      ],
    },
  ],
