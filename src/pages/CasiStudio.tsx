...
const caseStudies: CaseStudy[] = [
  {
    ...
    reduction: "80%",
    quote: "Pensavamo di perdere tutto. Grazie a RF Ristrutturazioni Debiti abbiamo salvato la nostra casa e ricostruito la nostra vita. Oggi guardiamo al futuro con speranza.",
...
const CasiStudio = () => {
  ...
  return (
    <>
      <Helmet>
        <title>Casi Studio | RF Ristrutturazioni Debiti - Storie di Successo</title>
