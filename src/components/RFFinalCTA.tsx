    ...
    <section ref={ref} className="py-24 md:py-32 relative overflow-hidden">
      ...
      <div className="container mx-auto px-4 relative z-10">
        <div className="max-w-3xl mx-auto text-center text-background">
          <div className={`w-20 h-20 rounded-2xl bg-gold/20 flex items-center justify-center mx-auto mb-8 transition-all duration-700 ${isInView ? 'opacity-100 scale-100' : 'opacity-0 scale-90'}`}>
